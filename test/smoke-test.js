...
describe('microservice rights smoke test', function() {
    ...
    it('should allow admin role to access admin url', function(done) {
        checkAccess( {
            role: "admin", 
            access: "admin", 
            status: 200,
    ...
    it('should allow admin role to access user url', function(done) {
        checkAccess( {
            role: "admin", 
            access: "user", 
            status: 200,
    ...
    it('should allow admin role to access wildcard url', function(done) {
        checkAccess( {
            role: "admin", 
            access: "*", 
            status: 200,
    ...
    it('should allow user role to access user url', function(done) {
        checkAccess( {
            role: "user", 
            access: "user", 
            status: 200,
    ...
    it('should allow user role to access wildcard url', function(done) {
        checkAccess( {
            role: "user", 
            access: "*", 
            status: 200,
    ...
    it('should allow wildcard role to access wilccard url', function(done) {
        checkAccess( {
            role: "*", 
            access: "*", 
            status: 200,  
